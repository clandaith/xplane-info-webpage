...
function newConvertSpeedToAngle(options) {
	/* Helper function to convert a speed to the 
	* equivelant angle.
	*/
...
// console.log("options.speed / 10: " + (options.speed / a));

// var iSpeed = (options.speed / a);
// console.log("iSpeed: " + iSpeed);

// console.log("iSpeed * 20: " + (iSpeed * b));
// console.log("((iSpeed * 20) + 10): " + ((iSpeed * b) + a));

// var iSpeedAsAngle = ((iSpeed * b) + a) % angleMod;
// console.log("iSpeedAsAngle: " + (((iSpeed * b) + a) % angleMod));


	

// 	// Ensure the angle is within range
// 	if (iSpeedAsAngle > angleMod) {
//         iSpeedAsAngle = iSpeedAsAngle - angleMod;
//     } else if (iSpeedAsAngle < 0) {
//         iSpeedAsAngle = iSpeedAsAngle + angleMod;
//     }
...
function drawNeedle(options) {
	...
	*/
	...
	var iSpeedAsAngle = newConvertSpeedToAngle(options),
...
function clearCanvas(options) {
	options.ctx.clearRect(0, 0, 150, 150);
	applyDefaultContextSettings(options);
}
...
function drawWithInputValue(speed) {
    iTargetSpeed = speed;
		...
		if (isNaN(iTargetSpeed)) {
					...
					iTargetSpeed = 0;
		} else if (iTargetSpeed > topSpeed) {
					iTargetSpeed = topSpeed;
    }
